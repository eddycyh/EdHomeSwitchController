...
esp_err_t blufi_initialise_wifi()
{
    ...
    ESP_LOGI(TAG, "Saved STA SSID %s\n", saved_sta_config.sta.ssid);
    ESP_LOGI(TAG, "Saved STA PASSWORD %s\n", saved_sta_config.sta.password);
    ...
    ESP_ERROR_CHECK( esp_wifi_set_config(ESP_IF_WIFI_STA, &saved_sta_config) );    
